...
d$monsoon_ut2 <- as.character(d$monsoon_ut2)
d$monsoon_ut2[is.na(d$monsoon_ut2)] <- "missing"
d$monsoon_t3_vital <- as.character(d$monsoon_t3_vital)
d$monsoon_t3_vital[is.na(d$monsoon_t3_vital)] <- "missing"
d$monsoon_t3_salimetrics <- as.character(d$monsoon_t3_salimetrics)
d$monsoon_t3_salimetrics[is.na(d$monsoon_t3_salimetrics)] <- "missing"
...
save(res_ipcw,  file = here::here("results/stress_ipcw.rdata"))
