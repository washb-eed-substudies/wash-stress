...
d <- rbind(
  data.frame(readjustfunc(res_unadj, "t2_f2_8ip"), name="iPF(2a)-III ", age=14, group="F2 Isoprostanes"),
  data.frame(readjustfunc(res_unadj, "t2_f2_23d"), name="2,3-dinor-iPF(2a)-III", age=14, group="F2 Isoprostanes"),
  data.frame(readjustfunc(res_unadj, "t2_f2_VI"), name="iPF(2a)-VI", age=14, group="F2 Isoprostanes"),
  data.frame(readjustfunc(res_unadj, "t2_f2_12i"), name="8,12-iso-iPF(2a)-VI", age=14, group="F2 Isoprostanes"),
